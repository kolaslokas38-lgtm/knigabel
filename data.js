    ...
    rewardsShop: [
        {
            ...
            description: 'Увеличивает скорость чтения на 50% на 24 часа',
            icon: '🚀',
            price: 100,
            consumable: true,
        ...
        },
        {
            ...
            description: 'Удваивает получаемый опыт за чтение на 48 часов',
            icon: '⚡',
            price: 150,
            consumable: true,
        ...
        },
        {
            ...
            title: 'Зелье мотивации',
            description: 'Увеличивает мотивацию к чтению на 100% на неделю',
            icon: '💪',
            price: 80,
            consumable: true,
        ...
        {
            id: 'streak_protector',
            title: 'Защитник серии',
            description: 'Защищает серию чтения от сброса на 7 дней',
            icon: '🛡️',
            price: 120,
            consumable: true,
        ...
        },
        {
            id: 'page_bonus',
            title: 'Бонус страниц',
            description: 'Добавляет +10 страниц к ежедневному прогрессу чтения',
            icon: '📄',
            price: 60,
            consumable: true,
        ...
        {
            id: 'focus_enhancer',
            title: 'Усилитель фокуса',
            description: 'Уменьшает отвлечения при чтении на 30 минут',
            icon: '🎯',
            price: 90,
            consumable: true,
        ...
        },
        {
            id: 'memory_booster',
            title: 'Бустер памяти',
            description: 'Улучшает запоминание прочитанного на 25%',
            icon: '🧠',
            price: 110,
            consumable: true,
        ...
        {
            id: 'reading_comfort',
            title: 'Комфорт чтения',
            description: 'Улучшает комфорт глаз при чтении на 2 часа',
            icon: '👁️',
            price: 70,
            consumable: true,
        ...
        },
        {
            ...
            title: 'Буст вдохновения',
            description: 'Увеличивает вдохновение для написания отзывов',
            icon: '✨',
            price: 95,
            consumable: true,
        ...
        {
            id: 'premium_reader',
            title: 'Премиум читатель',
            description: 'Специальный статус с бонусами к чтению',
            icon: '👑',
            price: 300,
            owned: false,
        ...
        },
        {
            ...
            title: 'Эликсир концентрации',
            description: 'Повышает концентрацию внимания на 200% на 3 часа',
            icon: '🔬',
            price: 130,
            consumable: true,
        ...
        },
        {
            ...
            title: 'Кристалл знаний',
            description: 'Увеличивает эффективность обучения на 50% на 12 часов',
            icon: '💎',
            price: 180,
            consumable: true,
        ...
        },
        {
            ...
            title: 'Зелье креативности',
            description: 'Стимулирует творческое мышление для анализа литературы',
            icon: '🎨',
            price: 140,
            consumable: true,
        ...
        {
            id: 'endurance_boost',
            title: 'Буст выносливости',
            description: 'Позволяет читать дольше без усталости на 8 часов',
            icon: '🏋️',
            price: 160,
            consumable: true,
        ...
        {
            id: 'wisdom_scroll',
            title: 'Свиток мудрости',
            description: 'Улучшает понимание сложных текстов на 30%',
            icon: '📜',
            price: 200,
            consumable: true,
        ...
        {
            id: 'review_mastery',
            title: 'Мастерство отзывов',
            description: 'Увеличивает качество написания отзывов на 100%',
            icon: '✍️',
            price: 120,
            consumable: true,
        ...
        },
        {
            id: 'genre_explorer',
            title: 'Исследователь жанров',
            description: 'Открывает новые жанры для изучения',
            icon: '🗺️',
            price: 250,
            consumable: true,
        ...
        },
        {
            ...
            description: 'Увеличивает взаимодействие с сообществом читателей',
            icon: '🤝',
            price: 170,
            consumable: true,
        ...
        },
        {
            ...
            title: 'Ускоритель достижений',
            description: 'Удваивает скорость получения достижений на 24 часа',
            icon: '🏆',
            price: 220,
            consumable: true,
        ...
        {
            id: 'ultimate_reader',
            title: 'Ультимативный читатель',
            description: 'Максимальный статус с полными бонусами',
            icon: '🌟',
            price: 500,
            owned: false,
