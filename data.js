...
const AUTHOR_BIOS = {
  'Лев Толстой': {
    bio: 'Лев Николаевич Толстой (1828–1910) — великий русский писатель, мыслитель и общественный деятель. Автор эпопеи "Война и мир" и романа "Анна Каренина". Его произведения затрагивают глубокие философские и нравственные вопросы. Толстой считается одним из величайших писателей мира, его влияние на русскую и мировую литературу огромно.',
    ...
    quotes: [
      ...
      'Любовь есть высшая и окончательная цель мира.'
    ]
  },
  'Федор Достоевский': {
    bio: 'Фёдор Михайлович Достоевский (1821–1881) — русский писатель, философ и публицист. Мастер психологического романа, исследующий глубины человеческой души. Его произведения полны глубоких размышлений о добре и зле, вере и безверии, свободе и необходимости.',
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/76/Dostoevsky_1876.jpg/330px-Dostoevsky_1876.jpg',
    famousWorks: ['Преступление и наказание', 'Идиот', 'Братья Карамазовы', 'Бесы', 'Записки из подполья'],
    quotes: [
  ...
  'Михаил Булгаков': {
    bio: 'Михаил Афанасьевич Булгаков (1891–1940) — русский писатель и драматург. Автор знаменитого романа "Мастер и Маргарита", полного мистики и сатиры. Его творчество сочетает фантастические элементы с острой социальной критикой.',
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8d/Bulgakov_1930s.jpg/330px-Bulgakov_1930s.jpg',
    famousWorks: ['Мастер и Маргарита', 'Собачье сердце', 'Белая гвардия', 'Роковые яйца'],
    quotes: [
      'Рукописи не горят!',
      'Никогда и ничего не просите! Никогда и ничего, и в особенности у тех, кто сильнее вас. Сами предложат и сами всё дадут!',
      'Всё пройдёт. Страдания, муки, кровь, голод и мор. И только одна останется бессмертной - правда.'
    ]
  },
  'Александр Пушкин': {
    bio: 'Александр Сергеевич Пушкин (1799–1837) — великий русский поэт, драматург и прозаик, основоположник современного русского литературного языка. Его произведения стали основой русской классической литературы.',
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/5a/Pushkin_1827.jpg/330px-Pushkin_1827.jpg',
    famousWorks: ['Евгений Онегин', 'Капитанская дочка', 'Медный всадник', 'Руслан и Людмила'],
    quotes: [
  ...
  'Михаил Шолохов': {
    bio: 'Михаил Александрович Шолохов (1905–1984) — русский писатель, лауреат Нобелевской премии по литературе. Его главное произведение - эпопея "Тихий Дон" о казачестве в период революций и войн.',
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Sholokhov_1960s.jpg/330px-Sholokhov_1960s.jpg',
    famousWorks: ['Тихий Дон', 'Поднятая целина', 'Судьба человека'],
    quotes: [
  ...
  'Иван Тургенев': {
    bio: 'Иван Сергеевич Тургенев (1818–1883) — русский писатель-реалист, поэт и драматург. Его произведения отражают социальные изменения в России XIX века и конфликт между либералами и консерваторами.',
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7c/Turgenev_1870s.jpg/330px-Turgenev_1870s.jpg',
    famousWorks: ['Отцы и дети', 'Дворянское гнездо', 'Рудин', 'Накануне'],
    quotes: [
  ...
  'Николай Гоголь': {
    bio: 'Николай Васильевич Гоголь (1809–1852) — русский писатель, драматург и поэт. Мастер сатиры и фантастики, его произведения полны юмора и глубокого психологизма.',
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Gogol_1840s.jpg/330px-Gogol_1840s.jpg',
    famousWorks: ['Мёртвые души', 'Ревизор', 'Шинель', 'Вий'],
    quotes: [
      'Хорошего понемножку.',
  ...
  'Михаил Лермонтов': {
    bio: 'Михаил Юрьевич Лермонтов (1814–1841) — великий русский поэт и прозаик. Его произведения полны романтизма, глубоких философских размышлений и критики общества.',
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/Lermontov_1837.jpg/330px-Lermontov_1837.jpg',
    famousWorks: ['Герой нашего времени', 'Демон', 'Бородино', 'Смерть поэта'],
    quotes: [
  ...
  'Антон Чехов': {
    bio: 'Антон Павлович Чехов (1860–1904) — русский писатель и драматург. Мастер короткого рассказа и психологической драмы. Его произведения отличаются тонким юмором и глубоким пониманием человеческой природы.',
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7c/Chekhov_1890s.jpg/330px-Chekhov_1890s.jpg',
    famousWorks: ['Вишнёвый сад', 'Чайка', 'Дядя Ваня', 'Палата №6'],
    quotes: [
  ...
  'Александр Грибоедов': {
    bio: 'Александр Сергеевич Грибоедов (1795–1829) — русский дипломат, поэт и драматург. Автор знаменитой комедии "Горе от ума", которая стала классикой русской литературы.',
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Griboyedov_1820s.jpg/330px-Griboyedov_1820s.jpg',
    famousWorks: ['Горе от ума'],
    quotes: [
  ...
  'Иван Гончаров': {
    bio: 'Иван Александрович Гончаров (1812–1891) — русский писатель, критик и журналист. Его главное произведение - роман "Обломов", ставший символом "обломовщины" в русской культуре.',
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8d/Goncharov_1850s.jpg/330px-Goncharov_1850s.jpg',
    famousWorks: ['Обломов', 'Обыкновенная история', 'Обрыв'],
    quotes: [
      'Обломовщина - это апатия, лень и безволие.',
      'Жизнь - это борьба.'
    ]
  },
  'Илья Ильф, Евгений Петров': {
    bio: 'Илья Ильф (1897–1937) и Евгений Петров (1902–1942) — советские писатели-сатирики. Их творчество отличается острым юмором и критикой бюрократии и мещанства.',
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Ilf_and_Petrov.jpg/330px-Ilf_and_Petrov.jpg',
    famousWorks: ['Двенадцать стульев', 'Золотой телёнок'],
    quotes: [
  ...
  'Борис Пастернак': {
    bio: 'Борис Леонидович Пастернак (1890–1960) — русский поэт и писатель, лауреат Нобелевской премии по литературе. Его роман "Доктор Живаго" стал мировым бестселлером.',
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7c/Pasternak_1950s.jpg/330px-Pasternak_1950s.jpg',
    famousWorks: ['Доктор Живаго', 'Сестра моя - жизнь'],
    quotes: [
  ...
  'Эрнест Хемингуэй': {
    bio: 'Эрнест Миллер Хемингуэй (1899–1961) — американский писатель, лауреат Нобелевской премии. Его стиль отличается лаконичностью и мужественностью. Писал о войне, любви и человеческом достоинстве.',
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Hemingway_1950s.jpg/330px-Hemingway_1950s.jpg',
    famousWorks: ['Старик и море', 'Прощай, оружие!', 'По ком звонит колокол'],
    quotes: [
      'Человек не рождается для поражения.',
      'Писать просто - это очень трудно.'
    ]
  },
  'Антуан де Сент-Экзюпери': {
    bio: 'Антуан де Сент-Экзюпери (1900–1944) — французский писатель, поэт и журналист. Его произведения полны философских размышлений о жизни, дружбе и человечности.',
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Saint-Exupery_1940s.jpg/330px-Saint-Exupery_1940s.jpg',
    famousWorks: ['Маленький принц', 'Ночной полёт', 'Планета людей'],
    quotes: [
  ...
  'Джордж Оруэлл': {
    bio: 'Джордж Оруэлл (1903–1950) — английский писатель и журналист. Его произведения стали символом антиутопии и критики тоталитаризма.',
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Orwell_1940s.jpg/330px-Orwell_1940s.jpg',
    famousWorks: ['1984', 'Скотный двор', 'Дни в Бирме'],
    quotes: [
  ...
  'Джоан Роулинг': {
    bio: 'Джоан Роулинг (род. 1965) — английская писательница. Стала знаменитой благодаря серии книг о Гарри Поттере, которые стали мировым феноменом.',
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Rowling_2010s.jpg/330px-Rowling_2010s.jpg',
    famousWorks: ['Гарри Поттер и философский камень', 'Гарри Поттер и тайная комната'],
    quotes: [
      'Страх побеждает только тогда, когда мы позволяем ему.',
      'Воображение важнее знаний.'
    ]
  },
  'Фрэнсис Скотт Фицджеральд': {
    bio: 'Фрэнсис Скотт Фицджеральд (1896–1940) — американский писатель. Представитель "потерянного поколения", его произведения отражают эпоху джаза и американскую мечту.',
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Fitzgerald_1920s.jpg/330px-Fitzgerald_1920s.jpg',
    famousWorks: ['Великий Гэтсби', 'Ночь нежна', 'Прекрасные и проклятые'],
    quotes: [
      'Так мы плывём, борясь с течением, сносимые назад к прошлому.',
      'Показать человеку его мечту - это самое жестокое, что можно сделать.'
    ]
  },
  'Габриэль Гарсия Маркес': {
    bio: 'Габриэль Гарсия Маркес (1927–2014) — колумбийский писатель, лауреат Нобелевской премии. Основатель магического реализма в литературе.',
    ...
    quotes: [
      'Жизнь не то, что с тобой происходит, а то, что ты вспоминаешь и как ты об этом рассказываешь.',
      'Человеку нужно только три вещи: любить то, что достойно любви, не любить то, что недостойно, и уметь отличать одно от другого.'
    ]
  },
  'Владимир Набоков': {
    bio: 'Владимир Владимирович Набоков (1899–1977) — русский и американский писатель. Его произведения отличаются сложным стилем и глубоким психологизмом.',
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Nabokov_1960s.jpg/330px-Nabokov_1960s.jpg',
    famousWorks: ['Лолита', 'Дар', 'Защита Лужина'],
    quotes: [
      'Литература - это изобретение, которое имеет тенденцию становиться всё более и более изощрённой.',
      'Гений - это терпение.'
    ]
  },
  'Джон Рональд Руэл Толкин': {
    bio: 'Джон Рональд Руэл Толкин (1892–1973) — английский писатель, поэт и филолог. Создатель мира Средиземья и отец современного фэнтези.',
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Tolkien_1960s.jpg/330px-Tolkien_1960s.jpg',
    famousWorks: ['Властелин колец', 'Хоббит', 'Сильмариллион'],
    quotes: [
      'Не все те, кто блуждает, потеряны.',
      'Всё, что нужно герою, - это меч и щит, и немного смелости.'
    ]
  },
  'Дмитрий Глуховский': {
    bio: 'Дмитрий Алексеевич Глуховский (род. 1979) — русский писатель и журналист. Его произведения сочетают постапокалиптику с социальной критикой.',
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Glukhovsky_2010s.jpg/330px-Glukhovsky_2010s.jpg',
    famousWorks: ['Метро 2033', 'Метро 2034', 'Будущее'],
    quotes: [
      'Война - это не романтика, война - это грязь и кровь.',
      'Будущее принадлежит тем, кто верит в него.'
    ]
  },
  'Александр Куприн': {
    bio: 'Александр Иванович Куприн (1870–1938) — русский писатель и журналист. Его произведения отличаются гуманизмом и глубоким пониманием человеческой души.',
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Kuprin_1910s.jpg/330px-Kuprin_1910s.jpg',
    famousWorks: ['Гранатовый браслет', 'Поединок', 'Чудесный доктор'],
    quotes: [
  ...
  'Харпер Ли': {
    bio: 'Харпер Ли (1926–2016) — американская писательница. Её единственный роман "Убить пересмешника" стал классикой американской литературы.',
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Lee_1960s.jpg/330px-Lee_1960s.jpg',
    famousWorks: ['Убить пересмешника'],
    quotes: [
      'Вы никогда не поймёте человека, пока не пройдёте милю в его мокасинах.',
      'Сострадание - это когда ты понимаешь чужую боль.'
    ]
  },
  'Артур Конан Дойл': {
    bio: 'Артур Конан Дойл (1859–1930) — шотландский писатель. Создатель знаменитого сыщика Шерлока Холмса, отец детективного жанра.',
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Doyle_1910s.jpg/330px-Doyle_1910s.jpg',
    famousWorks: ['Шерлок Холмс: Собака Баскервилей', 'Затерянный мир'],
    quotes: [
      'Элементарно, Ватсон!',
      'Когда вы исключили невозможное, то, что остаётся, каким бы невероятным оно ни казалось, должно быть истиной.'
    ]
  },
  'Джером Дэвид Сэлинджер': {
    bio: 'Джером Дэвид Сэлинджер (1919–2010) — американский писатель. Его произведения отражают бунт молодого поколения против общества.',
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Salinger_1950s.jpg/330px-Salinger_1950s.jpg',
    famousWorks: ['Над пропастью во ржи'],
    quotes: [
      'Все взрослые были когда-то детьми, но мало кто об этом помнит.',
      'Жизнь - это игра, в которой никто не знает правил.'
    ]
  },
  'Иван Бунин': {
    bio: 'Иван Алексеевич Бунин (1870–1953) — русский писатель, лауреат Нобелевской премии. Мастер психологической прозы и лирики.',
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Bunin_1920s.jpg/330px-Bunin_1920s.jpg',
    famousWorks: ['Тёмные аллеи', 'Господин из Сан-Франциско', 'Антоновские яблоки'],
    quotes: [
      'Счастье - это когда тебя понимают.',
      'Любовь - это самое сложное чувство на земле.'
    ]
  },
  'Ричард Бах': {
    bio: 'Ричард Дэвид Бах (род. 1936) — американский писатель. Его произведения полны философии и духовных поисков.',
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Bach_1980s.jpg/330px-Bach_1980s.jpg',
    famousWorks: ['Чайка по имени Джонатан Ливингстон', 'Иллюзии', 'Единственная'],
    quotes: [
      'Здесь, внизу, мы сражаемся с иллюзиями.',
      'Ты создаёшь свою собственную реальность.'
    ]
  },
  'Айн Рэнд': {
    bio: 'Айн Рэнд (1905–1982) — американская писательница и философ. Основательница объективизма, её произведения пропагандируют индивидуализм и капитализм.',
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Rand_1940s.jpg/330px-Rand_1940s.jpg',
    famousWorks: ['Атлант расправил плечи', 'Источник', 'Мы - живые'],
    quotes: [
      'Человек - это героическое существо, с индивидуальным умом, который он должен использовать.',
